...
public class MissionImpl implements Mission {
	...
	private void updatePreferences(SharedPreferences preferences) {
		...
		threatLevel = preferences.getInt("threatDifficultyPreference", 8);
		...
		maxPhaseTime[0] = (int) (missionLength * .4 + 35);
		maxPhaseTime[1] = (int) (missionLength * .35 + 35);
		maxPhaseTime[2] = (int) (missionLength * .25 + 35);		
	}
