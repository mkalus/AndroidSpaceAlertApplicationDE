...
public abstract class XmlHandler<T> {
	...
	public T parseAndHandle(XmlPullParser parser, ContentResolver resolver) throws HandlerException {
		try {
	...
	public abstract T parse(XmlPullParser parser, ContentResolver resolver, String authority)
